...
require 'mydatamyconsent/models/create_data_consent_request'
require 'mydatamyconsent/models/create_data_processing_agreement'
require 'mydatamyconsent/models/data_consent'
require 'mydatamyconsent/models/data_consent_details'
require 'mydatamyconsent/models/data_consent_document'
require 'mydatamyconsent/models/data_consent_financials_dto'
require 'mydatamyconsent/models/data_consent_request'
require 'mydatamyconsent/models/data_consent_request_details'
...
require 'mydatamyconsent/models/data_processing_agreement_base'
...
require 'mydatamyconsent/models/individual_data_consent'
require 'mydatamyconsent/models/individual_data_consent_details'
require 'mydatamyconsent/models/individual_data_consent_details_paginated_list'
require 'mydatamyconsent/models/individual_data_consent_document'
require 'mydatamyconsent/models/individual_data_consent_request_details'
require 'mydatamyconsent/models/individual_data_consent_request_details_paginated_list'
...
require 'mydatamyconsent/models/organization_data_consent'
require 'mydatamyconsent/models/organization_data_consent_details'
require 'mydatamyconsent/models/organization_data_consent_details_paginated_list'
require 'mydatamyconsent/models/organization_data_consent_document'
require 'mydatamyconsent/models/organization_data_consent_request_details'
require 'mydatamyconsent/models/organization_data_consent_request_details_paginated_list'
