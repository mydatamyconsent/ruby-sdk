...
module MyDataMyConsent
  class OrganizationKyoDocument
    ...
    attr_accessor :verified_by_user
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `MyDataMyConsent::OrganizationKyoDocument` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `MyDataMyConsent::OrganizationKyoDocument`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'verified_by_user')
        self.verified_by_user = attributes[:'verified_by_user']
      end
      ...
      if attributes.key?(:'rejection')
        self.rejection = attributes[:'rejection']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          verified_by_user == o.verified_by_user &&
    ...
    def hash
      [id, organization_id, document_name, storage_url, uploaded_at_utc, verified_by, verified_at_utc, deleted_by, deleted_at_utc, organization, verified_by_user, deleted_by_user, rejection].hash
    end
