...
module MyDataMyConsent
  ...
  class DocumentIssueRequestDetails
    ...
    def hash
      [id, document_type_id, type_name, identifier, status, description, receiver, payment_request, issued_at_utc, valid_from_utc, expires_at_utc, meta_data, created_at_utc].hash
    end
