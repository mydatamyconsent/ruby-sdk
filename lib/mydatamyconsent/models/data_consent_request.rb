...
module MyDataMyConsent
  ...
  class DataConsentRequest
    ...
    def hash
      [id, template_id, title, description, purpose, data_life, collectables, status, created_at_utc, expires_at_utc, approved_at_utc, data_access_expires_at_utc, rejected_at_utc, revoked_at_utc].hash
    end
