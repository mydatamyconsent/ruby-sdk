...
module MyDataMyConsent
  class OrganizationFinancialAccountDto
    ...
    def hash
      [id, organization_id, organization_name, beneficiary_name, account_number, routing_number, is_primary, is_verified, logo_url, bank_name, bank_account_type, bank_account_proof_url, file_type].hash
    end
