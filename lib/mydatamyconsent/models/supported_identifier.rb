  ...
  class SupportedIdentifier
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `MyDataMyConsent::SupportedIdentifier` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `MyDataMyConsent::SupportedIdentifier`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if @individual_identifiers.nil?
        invalid_properties.push('invalid value for "individual_identifiers", individual_identifiers cannot be nil.')
      end

      if @organization_identifiers.nil?
        invalid_properties.push('invalid value for "organization_identifiers", organization_identifiers cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @individual_identifiers.nil?
      return false if @organization_identifiers.nil?
      true
    end
