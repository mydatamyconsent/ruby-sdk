...
module MyDataMyConsent
  class DocumentProviderCategory
    ...
    attr_accessor :icon_font_family
    ...
    def self.openapi_types
      {
        ...
        :'icon_font_family' => :'CategoryIconFontFamily',
        :'meta_data' => :'AnyType'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `MyDataMyConsent::DocumentProviderCategory` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `MyDataMyConsent::DocumentProviderCategory`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'icon_font_family')
        self.icon_font_family = attributes[:'icon_font_family']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          icon_font_family == o.icon_font_family &&
    ...
    def hash
      [created_by, created_at_utc, updated_by, updated_at_utc, created_by_user, updated_by_user, deleted_by, deleted_at_utc, deleted_by_user, id, name, icon_code_point, icon_font_family, meta_data].hash
    end
