  ...
  class DataProviderDetails
    ...
    def self.openapi_types
      {
        ...
        :'data_protection_officer' => :'DataProtectionOfficer',
        :'supported_document_types' => :'Array<SupportedDocumentType>',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `MyDataMyConsent::DataProviderDetails` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `MyDataMyConsent::DataProviderDetails`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'term_of_service')
    ...
    def list_invalid_properties
      ...
      if @data_protection_officer.nil?
        invalid_properties.push('invalid value for "data_protection_officer", data_protection_officer cannot be nil.')
      end
      ...
      if @supported_account_types.nil?
        invalid_properties.push('invalid value for "supported_account_types", supported_account_types cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @data_protection_officer.nil?
      return false if @supported_document_types.nil?
      return false if @supported_account_types.nil?
      true
    end
