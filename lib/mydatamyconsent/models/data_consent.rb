...
module MyDataMyConsent
  class DataConsent
    ...
    attr_accessor :requested_by_org_id
    ...
    def self.openapi_types
      {
        ...
        :'requested_financial_accounts' => :'Array<DataConsentRequestedFinancialAccount>',
        :'requested_documents' => :'Array<DataConsentRequestedDocument>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `MyDataMyConsent::DataConsent` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `MyDataMyConsent::DataConsent`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'requested_by_org_id')
        self.requested_by_org_id = attributes[:'requested_by_org_id']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          requested_by_org_id == o.requested_by_org_id &&
    ...
    def hash
      [id, user_id, organization_id, requested_by_org_id, transaction_id, start_date_time, expiry_date_time, description, purpose_code, purpose_link, location, agreement_id, data_life_unit, data_life_value, data_fetch_frequency_unit, data_fetch_frequency_unit_value, data_fetch_type, status, created_at_utc, approved_at_utc, rejected_at_utc, user, organization, requested_by_org, agreement, identity_claims, identifiers, requested_financial_accounts, requested_documents].hash
    end
