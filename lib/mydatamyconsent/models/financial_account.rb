...
module MyDataMyConsent
  class FinancialAccount
    ...
    attr_accessor :account_logo_url
    ...
    attr_accessor :approved_consent_requests
    ...
    def self.openapi_types
      {
        ...
        :'balance_type' => :'String',
        :'is_shared' => :'Boolean',
        :'shared_with' => :'Array<SharedWith>',
        :'is_received' => :'Boolean',
        :'expires_at_utc' => :'Time',
        :'activities' => :'Array<Activity>',
        :'approved_consent_requests' => :'Array<ApprovedConsentRequest>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'account_logo_url')
        self.account_logo_url = attributes[:'account_logo_url']
      end
      ...
      if attributes.key?(:'approved_consent_requests')
        if (value = attributes[:'approved_consent_requests']).is_a?(Array)
          self.approved_consent_requests = value
        end
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          approved_consent_requests == o.approved_consent_requests
    end
    ...
    def hash
      [id, issuer, logo_url, category_id, category_name, account_name, account_logo_url, balance, balance_type, is_shared, shared_with, is_received, expires_at_utc, activities, approved_consent_requests].hash
    end
