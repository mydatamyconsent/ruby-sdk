  ...
  class FinancialAccountField
    ...
    def self.openapi_types
      {
        :'field_title' => :'String',
        :'field_slug' => :'String',
        :'account_types' => :'Array<SelectedFinancialAccountType>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `MyDataMyConsent::FinancialAccountField` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `MyDataMyConsent::FinancialAccountField`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if @account_types.nil?
        invalid_properties.push('invalid value for "account_types", account_types cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @account_types.nil?
      true
    end
    ...
    def hash
      [field_title, field_slug, account_types].hash
    end
